...
* Creación de un nuevo usuario con la extracción de su authToken.
* Creación de un nuevo kit asociado al nuevo usuario.
* Programación de pruebas automatizadas con referencia la lista de pruebas con respecto al nombre del kit.



Se generan 4 errores de las 9 pruebas realizadas.
